...
\begin{enumerate}
    ...
    \item downstream forecasting evaluation against TimesFM~\cite{timesfm}, demonstrating competitive benchmark performance from feature-bootstrapped pretraining.
\end{enumerate}
...
\bibitem{chronos2024}
A.~Ansari, L.~Stella, A.~Turkmen, and others,
``Chronos: Learning the language of time series,''
arXiv:2403.07815, 2024.

\bibitem{moirai2024}
G.~Woo, C.~Liu, A.~Kumar, and others,
``Unified training of universal time series forecasting transformers,''
arXiv:2402.02592, 2024.

\bibitem{lagllama2024}
K.~Rasul, A.~Ashok, A.~Williams, and others,
